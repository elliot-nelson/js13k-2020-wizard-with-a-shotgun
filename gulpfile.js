    ...
    return gulp.src('dist/temp/app.js')
        ...
        .pipe(terser({
            ...
            mangle: {
                properties: {
                    builtins: true,
                    regex: /behavior|direction|frame|reset|update|anchor|DEAD|canvas|entities|history|pressed|page|paused|resize|reload|pages|pattern|pause|unpause|sheet|state|init/
                }
            }
        }))
